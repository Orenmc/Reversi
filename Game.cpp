...
// first player points
	cout<< gameLogic->get_player(1)->getName() << " points: " <<gameLogic->get_player(1)->getPoints()  << endl;
// second player points
	cout<< gameLogic->get_player(2)->getName() << " points: " << gameLogic->get_player(2)->getPoints() << endl;
}

void Game::end_of_game(GameLogic* gl) const {
	int points1 = gl->get_player(1)->getPoints();
	int points2 = gl->get_player(2)->getPoints();
